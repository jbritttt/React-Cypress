...
// the up arrow symbol means get all items that start with accordion-item with data test attr
  cy.get('[data-test^="accordian-item"]').should('have.length', 3)

})


cy.contains(/Your tests will exist in a describe block/i).should('not.be.visible')
cy.getDataTest('accordian-item-1').within(() => cy.get('[role=button]').click())
